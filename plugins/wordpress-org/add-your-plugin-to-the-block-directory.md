...
If you’re a committer of a block plugin that does meet the criteria for adding it to the Block Directory as confirmed by the Checker tool, you can then add it yourself [using the Block Checker tool](https://wordpress.org/plugins/developers/block-plugin-validator/):

![](https://developer.wordpress.org/files/2020/08/Screen-Shot-2020-07-10-at-1.29.25-pm-1024x308.png)
